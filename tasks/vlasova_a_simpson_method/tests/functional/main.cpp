...
const std::array<TestType, 22> kTestCases = {
    ...
    std::make_tuple(std::vector<double>{0.0}, std::vector<double>{1.0}, std::vector<int>{10}, 1.0 / 3.0, "quadratic_1d"),
    ...
    std::make_tuple(std::vector<double>{-1.0}, std::vector<double>{1.0}, std::vector<int>{20}, 0.0, "linear_1d_symmetric"),
    std::make_tuple(std::vector<double>{0.0}, std::vector<double>{1.0}, std::vector<int>{10}, 0.25, "cubic_1d"),
    std::make_tuple(std::vector<double>{-1.0}, std::vector<double>{1.0}, std::vector<int>{20}, 0.0, "cubic_1d_symmetric"),
    std::make_tuple(std::vector<double>{0.0}, std::vector<double>{2.0}, std::vector<int>{20}, 2.0, "linear_1d_double"),

    // 2D
    std::make_tuple(std::vector<double>{0.0, 0.0}, std::vector<double>{1.0, 1.0}, std::vector<int>{10, 10}, 1.0, "constant_2d"),
    std::make_tuple(std::vector<double>{0.0, 0.0}, std::vector<double>{1.0, 1.0}, std::vector<int>{10, 10}, 0.25, "product_2d"),
    std::make_tuple(std::vector<double>{0.0, 0.0}, std::vector<double>{1.0, 1.0}, std::vector<int>{10, 10}, 2.0 / 3.0, "quadratic_2d"),
    std::make_tuple(std::vector<double>{-1.0, -1.0}, std::vector<double>{1.0, 1.0}, std::vector<int>{20, 20}, 0.0, "mixed_2d_symmetric"),
    std::make_tuple(std::vector<double>{0.0, 0.0}, std::vector<double>{1.0, 1.0}, std::vector<int>{10, 10}, 1.0 / 3.0, "quadratic_2d_only_x"),
    std::make_tuple(std::vector<double>{0.0, 0.0}, std::vector<double>{1.0, 1.0}, std::vector<int>{10, 10}, 1.0 / 3.0, "quadratic_2d_only_y"),
    // 3D
    std::make_tuple(std::vector<double>{0.0, 0.0, 0.0}, std::vector<double>{1.0, 1.0, 1.0}, std::vector<int>{8, 8, 8}, 1.0, "constant_3d"),
    std::make_tuple(std::vector<double>{0.0, 0.0, 0.0}, std::vector<double>{1.0, 1.0, 1.0}, std::vector<int>{8, 8, 8}, 0.125, "product_3d"),
    std::make_tuple(std::vector<double>{0.0, 0.0, 0.0}, std::vector<double>{1.0, 1.0, 1.0}, std::vector<int>{2, 2, 2}, 0.125, "product_3d_min"),
    std::make_tuple(std::vector<double>{0.0, 0.0, 0.0}, std::vector<double>{1.0, 1.0, 1.0}, std::vector<int>{50, 50, 50}, 0.125, "product_3d_mid"),
    std::make_tuple(std::vector<double>{-1.0, -1.0, -1.0}, std::vector<double>{1.0, 1.0, 1.0}, std::vector<int>{20, 20, 20}, 8.0, "constant_3d_symmetric"),
    std::make_tuple(std::vector<double>{-1.0, -1.0, -1.0}, std::vector<double>{1.0, 1.0, 1.0}, std::vector<int>{20, 20, 20}, 0.0, "product_3d_symmetric"),
    std::make_tuple(std::vector<double>{0.0, 0.0, 0.0}, std::vector<double>{1.0, 1.0, 1.0}, std::vector<int>{10, 10, 10}, 1.0, "quadratic_3d"),
    };
